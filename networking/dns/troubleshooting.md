...
### 4. "Zone not loaded" or "no response" errors

**Sympton:** `nslookup` returns SERVFAIL despite correct `db.cb`
**Solution:** Ensure zone is declared in `named.conf.local` and BIND restarted.
